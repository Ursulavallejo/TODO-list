...
describe('TESTING USER API ALIVE ROUTES', () => {
    ...
    deleteUserByNameUserDontExistExpect(newUser.name) //Magnus
    deleteUserByNameExpect(updatedUser.name) // Oliver
    deleteUserByNameUserDontExistExpect(updatedUser.name) // Oliver
